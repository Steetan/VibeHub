...
export const createUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        pool.query('INSERT INTO users (id, name, fname, password, email) VALUES ($1, $2, $3, $4, $5)', [uuidv4(), req.body.name, req.body.fname, req.body.password, req.body.email], (error, results) => {
            if (error)
                throw error;
            res.cookie('token', '123', { maxAge: 3600000, httpOnly: true });
            res.status(201).json({
                name: req.body.name,
